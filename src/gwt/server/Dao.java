...
import gwt.client.main.CopyOfGame;
...
public class Dao<T> extends DAOBase
{
	...
	static
	{
		...
		ObjectifyService.register(ServerGame.class);
		ObjectifyService.register(ServerCreation.class);
		ObjectifyService.register(ServerTree.class);
		
		ObjectifyService.register(GUser.class);
		ObjectifyService.register(ServerBag.class);
		
		ObjectifyService.register(JsonData.class);
...
//		ObjectifyService.register(AreaMap.class);
		// ...
	}
